...
public class TempProductAdapter extends RecyclerView.Adapter<TempProductAdapter.viewholder> {
    List<Product> list;
    Context context;

    DBHelper dbHelper;

    public TempProductAdapter(List<Product> list, Context context) {
        this.list = list;
